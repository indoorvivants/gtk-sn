...
/** A `GtkSpinButton` is an ideal way to allow the user to set the value of some
  ...
  */
class SpinButton private[gnome] (raw: Ptr[GtkSpinButton])
...
object SpinButton:
  ...
  def apply(
    ...
    summon[Runtime]
      .getOrCreate[SpinButton](raw, r => SpinButton.applyUnsafe(r.asInstanceOf))
  end apply
