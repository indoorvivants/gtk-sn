...
/** `GtkGridView` presents a large dynamic grid of items.
  ...
  */
class GridView private[gnome] (raw: Ptr[GtkGridView])
...
object GridView:
  ...
  def apply(
    ...
    summon[Runtime]
      .getOrCreate[GridView](raw, r => GridView.applyUnsafe(r.asInstanceOf))
  end apply
end GridView
