...
*/
opaque type _GtkTreeDragSourceIface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]

object _GtkTreeDragSourceIface:
  given _tag: Tag[_GtkTreeDragSourceIface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]
  ...
  private[internal] object fields:
    extension (struct: _GtkTreeDragSourceIface)
      ...
      inline def drag_data_get : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]] = struct._3
      inline def drag_data_get_=(value: CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]]): Unit = (!struct.at3 = value)
  ...
  // Allocates _GtkTreeDragSourceIface on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GtkTreeDragSourceIface] = scala.scalanative.unsafe.alloc[_GtkTreeDragSourceIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, row_draggable : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], drag_data_get : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]], drag_data_delete : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean])(using Zone): Ptr[_GtkTreeDragSourceIface] =
    val ____ptr = apply()
