...
*/
opaque type GtkTreeDragSourceIface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]

object GtkTreeDragSourceIface:
  given _tag: Tag[GtkTreeDragSourceIface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gdk4.internal.GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]
