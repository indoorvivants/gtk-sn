...
object GtkIMContextClass:
  ...
  private[internal] object fields:
    extension (struct: GtkIMContextClass)
      ...
      inline def filter_keypress: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean] = !struct.at(offsets(9)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]]]
      inline def filter_keypress_=(value: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]]] = value
      ...
      inline def set_cursor_location: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkRectangle], Unit] = !struct.at(offsets(13)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkRectangle], Unit]]]
      inline def set_cursor_location_=(value: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkRectangle], Unit]): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkRectangle], Unit]]] = value
      ...
      inline def activate_osk_with_event: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean] = !struct.at(offsets(20)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]]]
      inline def activate_osk_with_event_=(value: CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]]] = value
  ...
  // Allocates GtkIMContextClass on the heap – fields are not initalised or zeroed out
