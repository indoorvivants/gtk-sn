...
*/
opaque type GtkCellEditableIface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr2[Ptr[GtkCellEditable], Ptr[_root_.sn.gnome.gdk4.internal.GdkEvent], Unit]]

object GtkCellEditableIface:
  given _tag: Tag[GtkCellEditableIface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr2[Ptr[GtkCellEditable], Ptr[_root_.sn.gnome.gdk4.internal.GdkEvent], Unit]]
  ...
  // Allocates GtkCellEditableIface on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GtkCellEditableIface] = scala.scalanative.unsafe.alloc[GtkCellEditableIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, editing_done : CFuncPtr1[Ptr[GtkCellEditable], Unit], remove_widget : CFuncPtr1[Ptr[GtkCellEditable], Unit], start_editing : CFuncPtr2[Ptr[GtkCellEditable], Ptr[_root_.sn.gnome.gdk4.internal.GdkEvent], Unit])(using Zone): Ptr[GtkCellEditableIface] =
    val ____ptr = apply()
