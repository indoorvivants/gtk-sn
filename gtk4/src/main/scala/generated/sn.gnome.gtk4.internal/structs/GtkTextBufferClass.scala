...
*/
opaque type GtkTextBufferClass = CStruct20[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], CString, CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[_root_.sn.gnome.gdk4.internal.GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[_root_.sn.gnome.gdk4.internal.GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]

object GtkTextBufferClass:
  given _tag: Tag[GtkTextBufferClass] = Tag.materializeCStruct20Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], CString, CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[_root_.sn.gnome.gdk4.internal.GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[_root_.sn.gnome.gdk4.internal.GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  ...
  private[internal] object fields:
    extension (struct: GtkTextBufferClass)
      ...
      inline def insert_paintable : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[_root_.sn.gnome.gdk4.internal.GdkPaintable], Unit] = struct._3
      inline def insert_paintable_=(value: CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[_root_.sn.gnome.gdk4.internal.GdkPaintable], Unit]): Unit = (!struct.at3 = value)
      ...
      inline def paste_done : CFuncPtr2[Ptr[GtkTextBuffer], Ptr[_root_.sn.gnome.gdk4.internal.GdkClipboard], Unit] = struct._14
      inline def paste_done_=(value: CFuncPtr2[Ptr[GtkTextBuffer], Ptr[_root_.sn.gnome.gdk4.internal.GdkClipboard], Unit]): Unit = (!struct.at14 = value)
  ...
  // Allocates GtkTextBufferClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GtkTextBufferClass] = scala.scalanative.unsafe.alloc[GtkTextBufferClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, insert_text : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], CString, CInt, Unit], insert_paintable : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[_root_.sn.gnome.gdk4.internal.GdkPaintable], Unit], insert_child_anchor : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], delete_range : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], changed : CFuncPtr1[Ptr[GtkTextBuffer], Unit], modified_changed : CFuncPtr1[Ptr[GtkTextBuffer], Unit], mark_set : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], mark_deleted : CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], apply_tag : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], remove_tag : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], begin_user_action : CFuncPtr1[Ptr[GtkTextBuffer], Unit], end_user_action : CFuncPtr1[Ptr[GtkTextBuffer], Unit], paste_done : CFuncPtr2[Ptr[GtkTextBuffer], Ptr[_root_.sn.gnome.gdk4.internal.GdkClipboard], Unit], undo : CFuncPtr1[Ptr[GtkTextBuffer], Unit], redo : CFuncPtr1[Ptr[GtkTextBuffer], Unit], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkTextBufferClass] =
    val ____ptr = apply()
