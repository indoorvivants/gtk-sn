...
opaque type GtkColorChooserInterface = CStruct6[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr5[Ptr[GtkColorChooser], GtkOrientation, CInt, CInt, Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]]]

object GtkColorChooserInterface:
  given _tag: Tag[GtkColorChooserInterface] = Tag.materializeCStruct6Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr5[Ptr[GtkColorChooser], GtkOrientation, CInt, CInt, Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]]]
  ...
  def apply(base_interface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_rgba : CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], set_rgba : CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], add_palette : CFuncPtr5[Ptr[GtkColorChooser], GtkOrientation, CInt, CInt, Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], color_activated : CFuncPtr2[Ptr[GtkColorChooser], Ptr[_root_.sn.gnome.gdk4.internal.GdkRGBA], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]])(using Zone): Ptr[GtkColorChooserInterface] =
    val ____ptr = apply()
