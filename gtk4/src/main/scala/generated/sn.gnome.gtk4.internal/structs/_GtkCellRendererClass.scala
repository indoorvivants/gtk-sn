...
object _GtkCellRendererClass:
  ...
  private[internal] object fields:
    extension (struct: _GtkCellRendererClass)
      ...
      inline def get_aligned_area : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit] = struct._7
      inline def get_aligned_area_=(value: CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit]): Unit = (!struct.at7 = value)
      inline def snapshot : CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit] = struct._8
      inline def snapshot_=(value: CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit]): Unit = (!struct.at8 = value)
      inline def activate : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], CString, Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean] = struct._9
      inline def activate_=(value: CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], CString, Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at9 = value)
      inline def start_editing : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], CString, Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]] = struct._10
      inline def start_editing_=(value: CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], CString, Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]]): Unit = (!struct.at10 = value)
