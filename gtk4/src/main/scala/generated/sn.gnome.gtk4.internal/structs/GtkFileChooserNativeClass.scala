...
object GtkFileChooserNativeClass:
  ...
  private[internal] object fields:
    extension (struct: GtkFileChooserNativeClass)
      inline def parent_class : GtkNativeDialogClass = struct._1
      inline def parent_class_=(value: GtkNativeDialogClass): Unit = (!struct.at1 = value)
    end extension
  
  // Allocates GtkFileChooserNativeClass on the heap – fields are not initalised or zeroed out
