...
object _GtkMountOperationClass:
  ...
  private[internal] object fields:
    extension (struct: _GtkMountOperationClass)
      inline def parent_class : _root_.sn.gnome.gio.internal.GMountOperationClass = struct._1
      inline def parent_class_=(value: _root_.sn.gnome.gio.internal.GMountOperationClass): Unit = (!struct.at1 = value)
  ...
  // Allocates _GtkMountOperationClass on the heap – fields are not initalised or zeroed out
