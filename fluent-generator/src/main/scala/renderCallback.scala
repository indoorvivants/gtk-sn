...
// case class CallbackCall(
//   renderDataDefinition: RenderingContext => Unit,
//   // parameterType: String,
//   renderCallbackDefinition: RenderingContext => Unit,
// )

// def suspend(f: => RenderingContext ?=> Unit) =
//   (rc: RenderingContext) => f(using rc)

// def createCallbackCall(paramName: String, call: AugmentedCallback)(using
//     RenderingContext,
//     GlobalKnowledge,
//     NamingPolicy,
//     Label[FluentErr]
...
//     val captureDataParamName = paramName + "_data"

//     val dataDefinition = suspend:
//       line(s"val ${captureDataParamName} = ???")
...
// def renderCallback(cls: AugmentedClass, callback: AugmentedCallback)(using
//     RenderingContext,
//     GlobalKnowledge,
//     NamingPolicy,
//     Label[FluentErr]
