...
object _AdwPreferencesWindow:
  ...
  private[internal] object fields:
    extension (struct: _AdwPreferencesWindow)
      inline def parent_instance : AdwWindow = struct._1
      inline def parent_instance_=(value: AdwWindow): Unit = (!struct.at1 = value)
    end extension
  
  // Allocates _AdwPreferencesWindow on the heap – fields are not initalised or zeroed out
