...
object _AdwApplication:
  ...
  private[internal] object fields:
    extension (struct: _AdwApplication)
      inline def parent_instance : _root_.sn.gnome.gtk4.internal.GtkApplication = struct._1
      inline def parent_instance_=(value: _root_.sn.gnome.gtk4.internal.GtkApplication): Unit = (!struct.at1 = value)
    end extension
  
  // Allocates _AdwApplication on the heap – fields are not initalised or zeroed out
