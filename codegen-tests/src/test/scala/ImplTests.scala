  ...
  test("basics") {
    Zone:
      Runtime.use:
        ...
        assertEquals(inst.render(17), "25 - Howdy from Scala Native".take(17))
        ...
        val errQuark =
          g_quark_from_string(c"number validation".asInstanceOf)

        val res = inst.sqrtCount().toError
