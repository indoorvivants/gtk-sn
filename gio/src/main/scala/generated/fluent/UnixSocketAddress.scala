...
import sn.gnome.gio.{SocketAddress, SocketConnectable, UnixSocketAddressType}
...
class UnixSocketAddress private[gnome] (raw: Ptr[GUnixSocketAddress])
  ...
  /** Gets @address's type.
    ...
    */
  def getAddressType(): sn.gnome.gio.UnixSocketAddressType /* None */ =
    sn.gnome.gio.UnixSocketAddressType.fromRaw(
...
object UnixSocketAddress:
  ...
  )(using Runtime): UnixSocketAddress =
