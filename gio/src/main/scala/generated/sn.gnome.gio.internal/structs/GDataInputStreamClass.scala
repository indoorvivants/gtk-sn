...
object GDataInputStreamClass:
  ...
  private[internal] object fields:
    extension (struct: GDataInputStreamClass)
      inline def parent_class: GBufferedInputStreamClass = !struct.at(offsets(0)).asInstanceOf[Ptr[GBufferedInputStreamClass]]
      inline def parent_class_=(value: GBufferedInputStreamClass): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[GBufferedInputStreamClass]] = value
  ...
  // Allocates GDataInputStreamClass on the heap – fields are not initalised or zeroed out
