...
object _GThreadedSocketServiceClass:
  ...
  private[internal] object fields:
    extension (struct: _GThreadedSocketServiceClass)
      inline def parent_class : GSocketServiceClass = struct._1
      inline def parent_class_=(value: GSocketServiceClass): Unit = (!struct.at1 = value)
      inline def run : CFuncPtr3[Ptr[GThreadedSocketService], Ptr[GSocketConnection], Ptr[_root_.sn.gnome.gobject.internal.GObject], _root_.sn.gnome.glib.internal.gboolean] = struct._2
      inline def run_=(value: CFuncPtr3[Ptr[GThreadedSocketService], Ptr[GSocketConnection], Ptr[_root_.sn.gnome.gobject.internal.GObject], _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at2 = value)
  ...
  // Allocates _GThreadedSocketServiceClass on the heap – fields are not initalised or zeroed out
