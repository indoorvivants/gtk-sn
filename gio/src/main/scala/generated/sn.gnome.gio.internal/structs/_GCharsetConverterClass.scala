...
object _GCharsetConverterClass:
  ...
  // Allocates _GCharsetConverterClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GCharsetConverterClass] = scala.scalanative.unsafe.alloc[_GCharsetConverterClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[_GCharsetConverterClass] =
    val ____ptr = apply()
