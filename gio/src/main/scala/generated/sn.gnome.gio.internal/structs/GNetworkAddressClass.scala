...
object GNetworkAddressClass:
  ...
  // Allocates GNetworkAddressClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GNetworkAddressClass] = scala.scalanative.unsafe.alloc[GNetworkAddressClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GNetworkAddressClass] =
    val ____ptr = apply()
