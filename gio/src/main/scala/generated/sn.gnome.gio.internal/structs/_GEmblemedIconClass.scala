...
object _GEmblemedIconClass:
  ...
  // Allocates _GEmblemedIconClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GEmblemedIconClass] = scala.scalanative.unsafe.alloc[_GEmblemedIconClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[_GEmblemedIconClass] =
    val ____ptr = apply()
