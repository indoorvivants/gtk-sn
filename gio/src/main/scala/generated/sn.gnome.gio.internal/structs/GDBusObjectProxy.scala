...
object GDBusObjectProxy:
  ...
  private[internal] object fields:
    extension (struct: GDBusObjectProxy)
      ...
      inline def priv: Ptr[GDBusObjectProxyPrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusObjectProxyPrivate]]]
      inline def priv_=(value: Ptr[GDBusObjectProxyPrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusObjectProxyPrivate]]] = value
    end extension
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GDBusObjectProxyPrivate])(using Zone): Ptr[GDBusObjectProxy] =
    val ____ptr = apply()
  ...
  val offsets: Array[Int] =
    ...
    res(1) = align(res(0) + sizeof[_root_.sn.gnome.gobject.internal.GObject].toInt, alignmentof[Ptr[GDBusObjectProxyPrivate]].toInt)
    res
  end offsets