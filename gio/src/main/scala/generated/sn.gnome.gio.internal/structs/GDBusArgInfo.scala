...
object GDBusArgInfo:
  ...
  def apply(ref_count : _root_.sn.gnome.glib.internal.gint, name : Ptr[_root_.sn.gnome.glib.internal.gchar], signature : Ptr[_root_.sn.gnome.glib.internal.gchar], annotations : Ptr[Ptr[GDBusAnnotationInfo]])(using Zone): Ptr[GDBusArgInfo] =
    val ____ptr = apply()
