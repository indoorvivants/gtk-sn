...
object _GDataInputStreamClass:
  ...
  private[internal] object fields:
    extension (struct: _GDataInputStreamClass)
      inline def parent_class : GBufferedInputStreamClass = struct._1
      inline def parent_class_=(value: GBufferedInputStreamClass): Unit = (!struct.at1 = value)
  ...
  // Allocates _GDataInputStreamClass on the heap – fields are not initalised or zeroed out
