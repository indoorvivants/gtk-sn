...
object GDBusProxy:
  ...
  private[internal] object fields:
    extension (struct: GDBusProxy)
      ...
      inline def priv: Ptr[GDBusProxyPrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusProxyPrivate]]]
      inline def priv_=(value: Ptr[GDBusProxyPrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusProxyPrivate]]] = value
    end extension
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GDBusProxyPrivate])(using Zone): Ptr[GDBusProxy] =
    val ____ptr = apply()
  ...
  val offsets: Array[Int] =
    ...
    res(1) = align(res(0) + sizeof[_root_.sn.gnome.gobject.internal.GObject].toInt, alignmentof[Ptr[GDBusProxyPrivate]].toInt)
    res
  end offsets