...
object GMenuModel:
  ...
  private[internal] object fields:
    extension (struct: GMenuModel)
      ...
      inline def priv: Ptr[GMenuModelPrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GMenuModelPrivate]]]
      inline def priv_=(value: Ptr[GMenuModelPrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GMenuModelPrivate]]] = value
    end extension
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GMenuModelPrivate])(using Zone): Ptr[GMenuModel] =
    val ____ptr = apply()
  ...
  val offsets: Array[Int] =
    ...
    res(1) = align(res(0) + sizeof[_root_.sn.gnome.gobject.internal.GObject].toInt, alignmentof[Ptr[GMenuModelPrivate]].toInt)
    res
  end offsets