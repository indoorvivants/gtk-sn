...
object _GFileIOStreamClass:
  ...
  private[internal] object fields:
    extension (struct: _GFileIOStreamClass)
      ...
      inline def tell : CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset] = struct._2
      inline def tell_=(value: CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset]): Unit = (!struct.at2 = value)
      inline def can_seek : CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.gboolean] = struct._3
      inline def can_seek_=(value: CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at3 = value)
      inline def seek : CFuncPtr5[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset, _root_.sn.gnome.glib.internal.GSeekType, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], _root_.sn.gnome.glib.internal.gboolean] = struct._4
      inline def seek_=(value: CFuncPtr5[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset, _root_.sn.gnome.glib.internal.GSeekType, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at4 = value)
      inline def can_truncate : CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.gboolean] = struct._5
      inline def can_truncate_=(value: CFuncPtr1[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at5 = value)
      inline def truncate_fn : CFuncPtr4[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], _root_.sn.gnome.glib.internal.gboolean] = struct._6
      inline def truncate_fn_=(value: CFuncPtr4[Ptr[GFileIOStream], _root_.sn.gnome.glib.internal.goffset, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], _root_.sn.gnome.glib.internal.gboolean]): Unit = (!struct.at6 = value)
      inline def query_info : CFuncPtr4[Ptr[GFileIOStream], CString, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[GFileInfo]] = struct._7
      inline def query_info_=(value: CFuncPtr4[Ptr[GFileIOStream], CString, Ptr[GCancellable], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[GFileInfo]]): Unit = (!struct.at7 = value)
      inline def query_info_async : CFuncPtr6[Ptr[GFileIOStream], CString, CInt, Ptr[GCancellable], GAsyncReadyCallback, _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._8
      inline def query_info_async_=(value: CFuncPtr6[Ptr[GFileIOStream], CString, CInt, Ptr[GCancellable], GAsyncReadyCallback, _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = (!struct.at8 = value)
      inline def query_info_finish : CFuncPtr3[Ptr[GFileIOStream], Ptr[GAsyncResult], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[GFileInfo]] = struct._9
      inline def query_info_finish_=(value: CFuncPtr3[Ptr[GFileIOStream], Ptr[GAsyncResult], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[GFileInfo]]): Unit = (!struct.at9 = value)
      inline def get_etag : CFuncPtr1[Ptr[GFileIOStream], CString] = struct._10
      inline def get_etag_=(value: CFuncPtr1[Ptr[GFileIOStream], CString]): Unit = (!struct.at10 = value)
  ...
  // Allocates _GFileIOStreamClass on the heap – fields are not initalised or zeroed out
