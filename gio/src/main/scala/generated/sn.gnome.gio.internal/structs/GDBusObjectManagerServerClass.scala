...
object GDBusObjectManagerServerClass:
  ...
  // Allocates GDBusObjectManagerServerClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GDBusObjectManagerServerClass] = scala.scalanative.unsafe.alloc[GDBusObjectManagerServerClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GDBusObjectManagerServerClass] =
    val ____ptr = apply()
