...
object GDBusObjectManagerClient:
  ...
  private[internal] object fields:
    extension (struct: GDBusObjectManagerClient)
      ...
      inline def priv: Ptr[GDBusObjectManagerClientPrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusObjectManagerClientPrivate]]]
      inline def priv_=(value: Ptr[GDBusObjectManagerClientPrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GDBusObjectManagerClientPrivate]]] = value
    end extension
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GDBusObjectManagerClientPrivate])(using Zone): Ptr[GDBusObjectManagerClient] =
    val ____ptr = apply()
  ...
  val offsets: Array[Int] =
    ...
    res(1) = align(res(0) + sizeof[_root_.sn.gnome.gobject.internal.GObject].toInt, alignmentof[Ptr[GDBusObjectManagerClientPrivate]].toInt)
    res
  end offsets