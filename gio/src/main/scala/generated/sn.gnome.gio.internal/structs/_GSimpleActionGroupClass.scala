...
object _GSimpleActionGroupClass:
  ...
  private[internal] object fields:
    extension (struct: _GSimpleActionGroupClass)
      ...
      inline def padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]] = struct._2
      inline def padding_=(value: CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]]): Unit = (!struct.at2 = value)
    end extension
  
  // Allocates _GSimpleActionGroupClass on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GSimpleActionGroupClass] = scala.scalanative.unsafe.alloc[_GSimpleActionGroupClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]])(using Zone): Ptr[_GSimpleActionGroupClass] =
    val ____ptr = apply()
