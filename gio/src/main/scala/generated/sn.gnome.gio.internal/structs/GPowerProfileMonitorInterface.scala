...
object GPowerProfileMonitorInterface:
  ...
  // Allocates GPowerProfileMonitorInterface on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GPowerProfileMonitorInterface] = scala.scalanative.unsafe.alloc[GPowerProfileMonitorInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface)(using Zone): Ptr[GPowerProfileMonitorInterface] =
    val ____ptr = apply()
