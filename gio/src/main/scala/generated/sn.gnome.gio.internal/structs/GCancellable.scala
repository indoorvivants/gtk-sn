...
object GCancellable:
  ...
  private[internal] object fields:
    extension (struct: GCancellable)
      ...
      inline def priv: Ptr[GCancellablePrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GCancellablePrivate]]]
      inline def priv_=(value: Ptr[GCancellablePrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GCancellablePrivate]]] = value
    end extension
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GCancellablePrivate])(using Zone): Ptr[GCancellable] =
    val ____ptr = apply()
  ...
  val offsets: Array[Int] =
    ...
    res(1) = align(res(0) + sizeof[_root_.sn.gnome.gobject.internal.GObject].toInt, alignmentof[Ptr[GCancellablePrivate]].toInt)
    res
  end offsets