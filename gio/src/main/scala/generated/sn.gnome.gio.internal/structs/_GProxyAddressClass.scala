...
object _GProxyAddressClass:
  ...
  private[internal] object fields:
    extension (struct: _GProxyAddressClass)
      inline def parent_class : GInetSocketAddressClass = struct._1
      inline def parent_class_=(value: GInetSocketAddressClass): Unit = (!struct.at1 = value)
    end extension
  
  // Allocates _GProxyAddressClass on the heap – fields are not initalised or zeroed out
