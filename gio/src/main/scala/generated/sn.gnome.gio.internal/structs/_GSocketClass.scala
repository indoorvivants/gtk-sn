...
object _GSocketClass:
  ...
  private[internal] object fields:
    extension (struct: _GSocketClass)
      ...
      inline def _g_reserved8 : CFuncPtr0[Unit] = struct._9
      inline def _g_reserved8_=(value: CFuncPtr0[Unit]): Unit = (!struct.at9 = value)
      inline def _g_reserved9 : CFuncPtr0[Unit] = struct._10
      inline def _g_reserved9_=(value: CFuncPtr0[Unit]): Unit = (!struct.at10 = value)
      inline def _g_reserved10 : CFuncPtr0[Unit] = struct._11
      inline def _g_reserved10_=(value: CFuncPtr0[Unit]): Unit = (!struct.at11 = value)
    end extension
  
  // Allocates _GSocketClass on the heap – fields are not initalised or zeroed out
