...
object GTlsConnection:
  ...
  private[internal] object fields:
    extension (struct: GTlsConnection)
      ...
      inline def priv: Ptr[GTlsConnectionPrivate] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GTlsConnectionPrivate]]]
      inline def priv_=(value: Ptr[GTlsConnectionPrivate]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[GTlsConnectionPrivate]]] = value
    end extension
  
  // Allocates GTlsConnection on the heap – fields are not initalised or zeroed out
