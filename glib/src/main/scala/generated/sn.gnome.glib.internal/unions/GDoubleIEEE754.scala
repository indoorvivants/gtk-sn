...
opaque type GDoubleIEEE754_Mpn = CStruct4[guint, guint, guint, guint]

object GDoubleIEEE754_Mpn:
  given _tag: Tag[GDoubleIEEE754_Mpn] = Tag.materializeCStruct4Tag[guint, guint, guint, guint]
  ...
  def apply(mantissa_low : guint, mantissa_high : guint, biased_exponent : guint, sign : guint)(using Zone): Ptr[GDoubleIEEE754_Mpn] =
    val ____ptr = apply()
