...
object _GFloatIEEE754:
  ...
  def apply(v_float: _root_.sn.gnome.glib.internal.gfloat)(using Zone): Ptr[_GFloatIEEE754] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[_GFloatIEEE754](1)
    val un = !___ptr
...
opaque type _GFloatIEEE754_Mpn = CStruct3[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]

object _GFloatIEEE754_Mpn:
  given _tag: Tag[_GFloatIEEE754_Mpn] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]
  
  export fields.*
  private[internal] object fields:
    extension (struct: _GFloatIEEE754_Mpn)
      inline def mantissa : _root_.sn.gnome.glib.internal.guint = struct._1
      inline def mantissa_=(value: _root_.sn.gnome.glib.internal.guint): Unit = (!struct.at1 = value)
      inline def biased_exponent : _root_.sn.gnome.glib.internal.guint = struct._2
      inline def biased_exponent_=(value: _root_.sn.gnome.glib.internal.guint): Unit = (!struct.at2 = value)
      inline def sign : _root_.sn.gnome.glib.internal.guint = struct._3
      inline def sign_=(value: _root_.sn.gnome.glib.internal.guint): Unit = (!struct.at3 = value)
    end extension
  ...
  def apply(mantissa : _root_.sn.gnome.glib.internal.guint, biased_exponent : _root_.sn.gnome.glib.internal.guint, sign : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[_GFloatIEEE754_Mpn] =
    val ____ptr = apply()
