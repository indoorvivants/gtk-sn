...
object _GDoubleIEEE754:
  ...
  def apply(v_double: _root_.sn.gnome.glib.internal.gdouble)(using Zone): Ptr[_GDoubleIEEE754] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[_GDoubleIEEE754](1)
    val un = !___ptr
...
opaque type _GDoubleIEEE754_Mpn = CStruct4[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]

object _GDoubleIEEE754_Mpn:
  given _tag: Tag[_GDoubleIEEE754_Mpn] = Tag.materializeCStruct4Tag[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(mantissa_low : _root_.sn.gnome.glib.internal.guint, mantissa_high : _root_.sn.gnome.glib.internal.guint, biased_exponent : _root_.sn.gnome.glib.internal.guint, sign : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[_GDoubleIEEE754_Mpn] =
    val ____ptr = apply()
