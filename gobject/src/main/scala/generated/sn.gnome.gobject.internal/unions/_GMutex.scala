...
object _GMutex:
  ...
  def apply(p: _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[_GMutex] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[_GMutex](1)
    val un = !___ptr
  ...
  def apply(i: CArray[_root_.sn.gnome.glib.internal.guint, Nat._2])(using Zone): Ptr[_GMutex] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[_GMutex](1)
    val un = !___ptr
