...
object _GEnumValue:
  ...
  private[internal] object fields:
    extension (struct: _GEnumValue)
      inline def value : _root_.sn.gnome.glib.internal.gint = struct._1
      inline def value_=(value: _root_.sn.gnome.glib.internal.gint): Unit = (!struct.at1 = value)
  ...
  // Allocates _GEnumValue on the heap – fields are not initalised or zeroed out
