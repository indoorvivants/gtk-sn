...
opaque type _GRWLock = CStruct2[_root_.sn.gnome.glib.internal.gpointer, CArray[_root_.sn.gnome.glib.internal.guint, Nat._2]]

object _GRWLock:
  given _tag: Tag[_GRWLock] = Tag.materializeCStruct2Tag[_root_.sn.gnome.glib.internal.gpointer, CArray[_root_.sn.gnome.glib.internal.guint, Nat._2]]
  ...
  def apply(p : _root_.sn.gnome.glib.internal.gpointer, i : CArray[_root_.sn.gnome.glib.internal.guint, Nat._2])(using Zone): Ptr[_GRWLock] =
    val ____ptr = apply()
    (!____ptr).p = p
    (!____ptr).i = i
    ____ptr