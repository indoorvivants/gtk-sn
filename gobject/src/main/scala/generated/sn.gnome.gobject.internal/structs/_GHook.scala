...
opaque type _GHook = CStruct8[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gulong, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify]

object _GHook:
  given _tag: Tag[_GHook] = Tag.materializeCStruct8Tag[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gulong, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify]
  ...
  def apply(data : _root_.sn.gnome.glib.internal.gpointer, next : Ptr[_root_.sn.gnome.glib.internal.GHook], prev : Ptr[_root_.sn.gnome.glib.internal.GHook], ref_count : _root_.sn.gnome.glib.internal.guint, hook_id : _root_.sn.gnome.glib.internal.gulong, flags : _root_.sn.gnome.glib.internal.guint, func : _root_.sn.gnome.glib.internal.gpointer, destroy : _root_.sn.gnome.glib.internal.GDestroyNotify)(using Zone): Ptr[_GHook] =
    val ____ptr = apply()
    (!____ptr).data = data
    (!____ptr).next = next
    (!____ptr).prev = prev
