...
object _GParamSpecInt:
  ...
  private[internal] object fields:
    extension (struct: _GParamSpecInt)
      ...
      inline def default_value : _root_.sn.gnome.glib.internal.gint = struct._4
      inline def default_value_=(value: _root_.sn.gnome.glib.internal.gint): Unit = (!struct.at4 = value)
    end extension
  
  // Allocates _GParamSpecInt on the heap – fields are not initalised or zeroed out
