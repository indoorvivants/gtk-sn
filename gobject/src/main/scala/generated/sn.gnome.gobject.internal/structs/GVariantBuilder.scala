...
object GVariantBuilder_U:
  ...
  def apply(x: CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[GVariantBuilder_U] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[GVariantBuilder_U](1)
    val un = !___ptr
...
opaque type GVariantBuilder_U_S = CStruct3[_root_.sn.gnome.glib.internal.gsize, Ptr[_root_.sn.gnome.glib.internal.GVariantType], CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]]]

object GVariantBuilder_U_S:
  given _tag: Tag[GVariantBuilder_U_S] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.gsize, Ptr[_root_.sn.gnome.glib.internal.GVariantType], CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]]]
  ...
  def apply(partial_magic : _root_.sn.gnome.glib.internal.gsize, `type` : Ptr[_root_.sn.gnome.glib.internal.GVariantType], y : CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]])(using Zone): Ptr[GVariantBuilder_U_S] =
    val ____ptr = apply()
