...
opaque type _GDebugKey = CStruct2[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.guint]

object _GDebugKey:
  given _tag: Tag[_GDebugKey] = Tag.materializeCStruct2Tag[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(key : Ptr[_root_.sn.gnome.glib.internal.gchar], value : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[_GDebugKey] =
    val ____ptr = apply()
    (!____ptr).key = key
    (!____ptr).value = value
    ____ptr