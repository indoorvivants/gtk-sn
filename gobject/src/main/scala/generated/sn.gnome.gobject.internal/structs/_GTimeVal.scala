...
opaque type _GTimeVal = CStruct2[_root_.sn.gnome.glib.internal.glong, _root_.sn.gnome.glib.internal.glong]

object _GTimeVal:
  given _tag: Tag[_GTimeVal] = Tag.materializeCStruct2Tag[_root_.sn.gnome.glib.internal.glong, _root_.sn.gnome.glib.internal.glong]
  ...
  // Allocates _GTimeVal on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GTimeVal] = scala.scalanative.unsafe.alloc[_GTimeVal](1)
  def apply(tv_sec : _root_.sn.gnome.glib.internal.glong, tv_usec : _root_.sn.gnome.glib.internal.glong)(using Zone): Ptr[_GTimeVal] =
    val ____ptr = apply()
