...
*/
opaque type _GPollFD = CStruct3[_root_.sn.gnome.glib.internal.gint, _root_.sn.gnome.glib.internal.gushort, _root_.sn.gnome.glib.internal.gushort]

object _GPollFD:
  given _tag: Tag[_GPollFD] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.gint, _root_.sn.gnome.glib.internal.gushort, _root_.sn.gnome.glib.internal.gushort]
  ...
  def apply(fd : _root_.sn.gnome.glib.internal.gint, events : _root_.sn.gnome.glib.internal.gushort, revents : _root_.sn.gnome.glib.internal.gushort)(using Zone): Ptr[_GPollFD] =
    val ____ptr = apply()
    (!____ptr).fd = fd
