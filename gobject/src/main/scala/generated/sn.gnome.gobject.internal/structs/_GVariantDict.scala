...
object _GVariantDict_U:
  ...
  def apply(x: CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[_GVariantDict_U] =
    val ___ptr = _root_.scala.scalanative.unsafe.alloc[_GVariantDict_U](1)
    val un = !___ptr
...
opaque type _GVariantDict_U_S = CStruct3[Ptr[_root_.sn.gnome.glib.internal.GVariant], _root_.sn.gnome.glib.internal.gsize, CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]]]

object _GVariantDict_U_S:
  given _tag: Tag[_GVariantDict_U_S] = Tag.materializeCStruct3Tag[Ptr[_root_.sn.gnome.glib.internal.GVariant], _root_.sn.gnome.glib.internal.gsize, CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]]]
  ...
  def apply(asv : Ptr[_root_.sn.gnome.glib.internal.GVariant], partial_magic : _root_.sn.gnome.glib.internal.gsize, y : CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._4]])(using Zone): Ptr[_GVariantDict_U_S] =
    val ____ptr = apply()
    (!____ptr).asv = asv
