...
opaque type _GDate = CStruct6[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]

object _GDate:
  given _tag: Tag[_GDate] = Tag.materializeCStruct6Tag[_root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(julian_days : _root_.sn.gnome.glib.internal.guint, julian : _root_.sn.gnome.glib.internal.guint, dmy : _root_.sn.gnome.glib.internal.guint, day : _root_.sn.gnome.glib.internal.guint, month : _root_.sn.gnome.glib.internal.guint, year : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[_GDate] =
    val ____ptr = apply()
