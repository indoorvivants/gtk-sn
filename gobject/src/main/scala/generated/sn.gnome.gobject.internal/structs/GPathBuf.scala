...
opaque type GPathBuf = CStruct1[CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]

object GPathBuf:
  given _tag: Tag[GPathBuf] = Tag.materializeCStruct1Tag[CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  ...
  def apply(dummy : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GPathBuf] =
    val ____ptr = apply()
    (!____ptr).dummy = dummy
    ____ptr