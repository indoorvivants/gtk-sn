...
opaque type _GVariantIter = CStruct1[CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._6]]]

object _GVariantIter:
  given _tag: Tag[_GVariantIter] = Tag.materializeCStruct1Tag[CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._6]]]
  ...
  def apply(x : CArray[_root_.sn.gnome.glib.internal.guintptr, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[_GVariantIter] =
    val ____ptr = apply()
    (!____ptr).x = x
    ____ptr