...
opaque type _GSource = CStruct13[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.glib.internal.GMainContext], _root_.sn.gnome.glib.internal.gint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[Byte], Ptr[Byte], Ptr[Byte], CString, Ptr[_root_.sn.gnome.glib.internal.GSourcePrivate]]

object _GSource:
  given _tag: Tag[_GSource] = Tag.materializeCStruct13Tag[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.glib.internal.GMainContext], _root_.sn.gnome.glib.internal.gint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[Byte], Ptr[Byte], Ptr[Byte], CString, Ptr[_root_.sn.gnome.glib.internal.GSourcePrivate]]
