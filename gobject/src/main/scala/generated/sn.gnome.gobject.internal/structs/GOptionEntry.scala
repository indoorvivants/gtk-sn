...
object GOptionEntry:
  ...
  def apply(long_name : Ptr[_root_.sn.gnome.glib.internal.gchar], short_name : _root_.sn.gnome.glib.internal.gchar, flags : _root_.sn.gnome.glib.internal.gint, arg : _root_.sn.gnome.glib.internal.GOptionArg, arg_data : _root_.sn.gnome.glib.internal.gpointer, description : Ptr[_root_.sn.gnome.glib.internal.gchar], arg_description : Ptr[_root_.sn.gnome.glib.internal.gchar])(using Zone): Ptr[GOptionEntry] =
    val ____ptr = apply()
