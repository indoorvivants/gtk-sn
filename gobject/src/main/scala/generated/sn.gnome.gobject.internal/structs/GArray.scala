...
opaque type GArray = CStruct2[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.guint]

object GArray:
  given _tag: Tag[GArray] = Tag.materializeCStruct2Tag[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(data : Ptr[_root_.sn.gnome.glib.internal.gchar], len : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[GArray] =
    val ____ptr = apply()
    (!____ptr).data = data
    (!____ptr).len = len
    ____ptr