...
object _GParamSpecInt64:
  ...
  private[internal] object fields:
    extension (struct: _GParamSpecInt64)
      ...
      inline def minimum : _root_.sn.gnome.glib.internal.gint64 = struct._2
      inline def minimum_=(value: _root_.sn.gnome.glib.internal.gint64): Unit = (!struct.at2 = value)
      inline def maximum : _root_.sn.gnome.glib.internal.gint64 = struct._3
      inline def maximum_=(value: _root_.sn.gnome.glib.internal.gint64): Unit = (!struct.at3 = value)
      inline def default_value : _root_.sn.gnome.glib.internal.gint64 = struct._4
      inline def default_value_=(value: _root_.sn.gnome.glib.internal.gint64): Unit = (!struct.at4 = value)
    end extension
  
  // Allocates _GParamSpecInt64 on the heap – fields are not initalised or zeroed out
