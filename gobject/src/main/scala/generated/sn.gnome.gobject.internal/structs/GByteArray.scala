...
opaque type GByteArray = CStruct2[Ptr[_root_.sn.gnome.glib.internal.guint8], _root_.sn.gnome.glib.internal.guint]

object GByteArray:
  given _tag: Tag[GByteArray] = Tag.materializeCStruct2Tag[Ptr[_root_.sn.gnome.glib.internal.guint8], _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(data : Ptr[_root_.sn.gnome.glib.internal.guint8], len : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[GByteArray] =
    val ____ptr = apply()
    (!____ptr).data = data
    (!____ptr).len = len
    ____ptr