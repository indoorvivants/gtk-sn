...
opaque type GCond = CStruct2[_root_.sn.gnome.glib.internal.gpointer, CArray[_root_.sn.gnome.glib.internal.guint, Nat._2]]

object GCond:
  given _tag: Tag[GCond] = Tag.materializeCStruct2Tag[_root_.sn.gnome.glib.internal.gpointer, CArray[_root_.sn.gnome.glib.internal.guint, Nat._2]]
  ...
  def apply(p : _root_.sn.gnome.glib.internal.gpointer, i : CArray[_root_.sn.gnome.glib.internal.guint, Nat._2])(using Zone): Ptr[GCond] =
    val ____ptr = apply()
    (!____ptr).p = p
    (!____ptr).i = i
    ____ptr