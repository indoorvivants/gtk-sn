...
opaque type GCompletion = CStruct5[Ptr[Byte], _root_.sn.gnome.glib.internal.GCompletionFunc, Ptr[_root_.sn.gnome.glib.internal.gchar], Ptr[Byte], _root_.sn.gnome.glib.internal.GCompletionStrncmpFunc]

object GCompletion:
  given _tag: Tag[GCompletion] = Tag.materializeCStruct5Tag[Ptr[Byte], _root_.sn.gnome.glib.internal.GCompletionFunc, Ptr[_root_.sn.gnome.glib.internal.gchar], Ptr[Byte], _root_.sn.gnome.glib.internal.GCompletionStrncmpFunc]
  ...
  def apply(items : Ptr[_root_.sn.gnome.glib.internal.GList], func : _root_.sn.gnome.glib.internal.GCompletionFunc, prefix : Ptr[_root_.sn.gnome.glib.internal.gchar], cache : Ptr[_root_.sn.gnome.glib.internal.GList], strncmp_func : _root_.sn.gnome.glib.internal.GCompletionStrncmpFunc)(using Zone): Ptr[GCompletion] =
    val ____ptr = apply()
    (!____ptr).items = items
    (!____ptr).func = func
