...
opaque type _GStaticRWLock = CStruct7[_root_.sn.gnome.glib.internal.GStaticMutex, Ptr[_root_.sn.gnome.glib.internal.GCond], Ptr[_root_.sn.gnome.glib.internal.GCond], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]

object _GStaticRWLock:
  given _tag: Tag[_GStaticRWLock] = Tag.materializeCStruct7Tag[_root_.sn.gnome.glib.internal.GStaticMutex, Ptr[_root_.sn.gnome.glib.internal.GCond], Ptr[_root_.sn.gnome.glib.internal.GCond], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]
  ...
  def apply(mutex : _root_.sn.gnome.glib.internal.GStaticMutex, read_cond : Ptr[_root_.sn.gnome.glib.internal.GCond], write_cond : Ptr[_root_.sn.gnome.glib.internal.GCond], read_counter : _root_.sn.gnome.glib.internal.guint, have_writer : _root_.sn.gnome.glib.internal.gboolean, want_to_read : _root_.sn.gnome.glib.internal.guint, want_to_write : _root_.sn.gnome.glib.internal.guint)(using Zone): Ptr[_GStaticRWLock] =
    val ____ptr = apply()
    (!____ptr).mutex = mutex
