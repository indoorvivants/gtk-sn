...
opaque type _GNode = CStruct5[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte]]

object _GNode:
  given _tag: Tag[_GNode] = Tag.materializeCStruct5Tag[_root_.sn.gnome.glib.internal.gpointer, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte]]
  ...
  def apply(data : _root_.sn.gnome.glib.internal.gpointer, next : Ptr[_root_.sn.gnome.glib.internal.GNode], prev : Ptr[_root_.sn.gnome.glib.internal.GNode], parent : Ptr[_root_.sn.gnome.glib.internal.GNode], children : Ptr[_root_.sn.gnome.glib.internal.GNode])(using Zone): Ptr[_GNode] =
    val ____ptr = apply()
    (!____ptr).data = data
    (!____ptr).next = next
    (!____ptr).prev = prev
