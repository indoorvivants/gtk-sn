...
opaque type _GLogField = CStruct3[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.gconstpointer, _root_.sn.gnome.glib.internal.gssize]

object _GLogField:
  given _tag: Tag[_GLogField] = Tag.materializeCStruct3Tag[Ptr[_root_.sn.gnome.glib.internal.gchar], _root_.sn.gnome.glib.internal.gconstpointer, _root_.sn.gnome.glib.internal.gssize]
  ...
  // Allocates _GLogField on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GLogField] = scala.scalanative.unsafe.alloc[_GLogField](1)
  def apply(key : Ptr[_root_.sn.gnome.glib.internal.gchar], value : _root_.sn.gnome.glib.internal.gconstpointer, length : _root_.sn.gnome.glib.internal.gssize)(using Zone): Ptr[_GLogField] =
    val ____ptr = apply()
    (!____ptr).key = key
    (!____ptr).value = value
