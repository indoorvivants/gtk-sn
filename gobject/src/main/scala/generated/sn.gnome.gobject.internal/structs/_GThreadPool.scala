...
opaque type _GThreadPool = CStruct3[_root_.sn.gnome.glib.internal.GFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean]

object _GThreadPool:
  given _tag: Tag[_GThreadPool] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.GFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean]
  ...
  // Allocates _GThreadPool on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[_GThreadPool] = scala.scalanative.unsafe.alloc[_GThreadPool](1)
  def apply(func : _root_.sn.gnome.glib.internal.GFunc, user_data : _root_.sn.gnome.glib.internal.gpointer, exclusive : _root_.sn.gnome.glib.internal.gboolean)(using Zone): Ptr[_GThreadPool] =
    val ____ptr = apply()
    (!____ptr).func = func
