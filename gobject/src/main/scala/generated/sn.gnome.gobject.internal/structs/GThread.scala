...
opaque type GThread = CStruct4[_root_.sn.gnome.glib.internal.GThreadFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.GThreadPriority]

object GThread:
  given _tag: Tag[GThread] = Tag.materializeCStruct4Tag[_root_.sn.gnome.glib.internal.GThreadFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.GThreadPriority]
  ...
  // Allocates GThread on the heap – fields are not initalised or zeroed out
  def apply()(using Zone): Ptr[GThread] = scala.scalanative.unsafe.alloc[GThread](1)
  def apply(func : _root_.sn.gnome.glib.internal.GThreadFunc, data : _root_.sn.gnome.glib.internal.gpointer, joinable : _root_.sn.gnome.glib.internal.gboolean, priority : _root_.sn.gnome.glib.internal.GThreadPriority)(using Zone): Ptr[GThread] =
    val ____ptr = apply()
    (!____ptr).func = func
    (!____ptr).data = data
